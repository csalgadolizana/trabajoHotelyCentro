...
public class Ejecutivo  implements java.io.Serializable {
    ...
    public Ejecutivo(Empresa empresa, Persona persona, Usuario usuario, int estaActivo) {
        this.empresa = empresa;
        this.persona = persona;
        this.usuario = usuario;
        this.estaActivo = estaActivo;
    }
    public Ejecutivo(Empresa empresa, Persona persona, Usuario usuario, int estaActivo, Set calificacions, Set reservacions) {
       this.empresa = empresa;
       this.persona = persona;
       this.usuario = usuario;
       this.estaActivo = estaActivo;
