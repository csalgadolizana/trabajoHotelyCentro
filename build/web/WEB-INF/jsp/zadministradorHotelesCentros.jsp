    ...
    <body>
        ...
        <div class="container">
            <c:forEach   var="habitacion"  items="${listEmpresa}" varStatus="theCount" >
                ...
                <div class="container col-xs-6 col-md-4">
                    <div class="bordeCont">
                        ...
                        <div class="text-center">
                            ...
                            <a class="btn btn-lg btn-primary" href="#" role="button" data-toggle="modal" data-target="#modalEdit${habitacion.codigo}">Ver Mas </a>
                            <a class="btn btn-lg btn-danger" href="#" role="button" data-toggle="modal" data-target="#modalDelete${habitacion.codigo}">Borrar Habitacion<img class="" width="20" height="20" src="folder/img/icons/trash-icon.png" alt="Borrar" /></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="modalEdit${habitacion.codigo}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
